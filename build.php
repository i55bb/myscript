...
class GPage extends VillagePage 
    ...
    function handleMarketplace() 
        ...
        $this->merchantProperty = array( 
            'speed' => $tribeMetadata['	'] * $this->gameMetadata['game_speed'], 
        ...
        if ($this->selectedTabIndex == 0) 
            ...
            if (($this->isPost() || isset($_GET['vid2']))) 
                ...
                $this->merchantProperty['ip']                = $this->data['last_ip'] == $IP1; 				
                ...
                $this->merchantProperty['confirm_snd']       = ((((0 < $vid && $this->merchantProperty['available_res']) && 0 < $this->merchantProperty['vRow_merchant_num']) && $this->merchantProperty['vRow_merchant_num'] <= $this->merchantProperty['exits_num']) && !$this->merchantProperty['ip'] && !$this->merchantProperty['same_village']); 
